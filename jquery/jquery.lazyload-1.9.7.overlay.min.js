...
/* Add click overlay img */
$(function () { $("body").prepend('<div class="overlay"></div>'), $("img.lazy").on("click", function () { var t = $(window).width() / 2 + $(window).scrollLeft() - $(this).attr("width") / 2, i = $(window).height() / 2 + $(window).scrollTop() - $(this).attr("height") / 2; return $("div.overlay").css("height", $(document).height()), $("div.overlay").hide().empty(), $("div.overlay").append('<img src="' + $(this).attr("data-original") + '" attr="' + $(this).attr("attr") + '" />'), $("div.overlay img").css({ left: t, top: i, opacity: "1" }), $("div.overlay").fadeIn("fast"), !1 }), $("div.overlay").on("click", function () { $("div.overlay").fadeOut("fast") }) });